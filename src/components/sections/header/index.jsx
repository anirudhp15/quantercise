...
const Header = ({ onJoinClick }) => {
  ...
  const overlayColor = useMemo(
    () => (isPro ? "bg-blue-400" : "bg-green-400"),
    [isPro]
  );
        ...
        {isLandingPage || !userLoggedIn ? (
          <div className="flex items-center space-x-4">
            <Suspense fallback={<div>Loading...</div>}>
              ...
              >
                <PiUnionBold className="hidden w-8 h-8 mb-0 text-sm font-extrabold text-gray-400 transition duration-200 sm:block group-hover:text-gray-100" />
              </motion.div>
              <AuthButtons />
            </Suspense>
            <button
              ...
              <div className="flex items-center space-x-4">
                <button
                  className={`group flex rounded-lg items-center px-4 py-1 text-sm font-bold transform border-2 ${
                    isPro
                      ? "border-blue-400 hover:text-blue-400 bg-blue-400 text-black hover:bg-black"
                      : "border-green-400 hover:text-green-400 bg-green-400 text-black hover:bg-black"
                  } `}
              ...
              <AnimatePresence>
                {profileOpen && (
                  ...
                  >
                      ...
                      className={`z-10 absolute top-3 tracking-tighter left-8 md:left-28 text-xl font-black px-4 py-1 rounded-md transition duration-100 ${
                        isLandingPage
                          ...
                          : `text-black hover:text-white ${
                              isPro ? "hover:bg-blue-500" : "hover:bg-green-500"
                            }`
                      }`}
                      to="/landing"
                    >
                    ...
                    {/* Close button */}
                    <FaTimes
                      className="absolute text-black transition-all duration-200 cursor-pointer top-4 right-8 md:right-32 hover:text-gray-700 hover:scale-105"
                      size={30}
                      onClick={handleProfileToggle}
                    />
                    <div className="absolute w-full mx-auto border-t-4 border-black top-16 "></div>
                        ...
                        <RouterLink
                          ...
                          className={`flex flex-row tracking-wider justify-center w-full px-4 py-2 rounded-md ${
                            location.pathname === item.to
                              ? isPro
                                ? "bg-blue-300 hover:bg-blue-200 text-gray-700 hover:text-white"
                    ...
                    {/* Divider */}
                    <div className="w-3/4 mx-auto mt-4 border-t-4 border-gray-700"></div>
                    ...
                    <div className="flex flex-row justify-center mt-8 space-x-4">
                      <a
                        ...
                        className={`hover:text-[#181717] rounded-lg p-1 transition-all duration-100 hover:scale-110 ${
                          isPro ? "hover:bg-blue-500" : "hover:bg-green-500"
                        }`}
                      >
                        <FaGithub size={24} />
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className={`hover:text-[#0A66C2] rounded-lg p-1 transition-all duration-100 hover:scale-110 ${
                          isPro ? "hover:bg-blue-500" : "hover:bg-green-500"
                        }`}
                      >
                        <FaLinkedin size={24} />
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className={`hover:text-[#FF0000] rounded-lg p-1 transition-all duration-100 hover:scale-110 ${
                          isPro ? "hover:bg-blue-500" : "hover:bg-green-500"
                        }`}
                      >
                        <FaYoutube size={24} />
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className={`hover:text-[#E4405F] rounded-lg p-1 transition-all duration-100 hover:scale-110 ${
                          isPro ? "hover:bg-blue-500" : "hover:bg-green-500"
                        }`}
                      >
                        <FaInstagram size={24} />
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className={`hover:text-[#1DA1F2] rounded-lg p-1 transition-all duration-100 hover:scale-110 ${
                          isPro ? "hover:bg-blue-500" : "hover:bg-green-500"
                        }`}
                      >
                        <FaXTwitter size={24} />
