...
const Applications = () => {
  ...
  return (
    <div className="relative flex min-h-screen overflow-auto text-gray-300 bg-gradient-to-br from-gray-950 to-gray-900">
      ...
      <button
        onClick={() => setSmallSidebarExpanded(true)}
        className="absolute right-0 z-20 p-4 text-gray-400 hover:text-gray-300 lg:hidden"
      >
      ...
      {/* Main Content */}
      <div
        className={`relative z-10 flex-col justify-center w-full px-4 py-8 ${
          sidebarExpanded ? "lg:ml-64" : "mx-auto"
        } lg:px-20 sm:max-w-screen-md md:max-w-screen-lg lg:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl`}
      >
        <motion.h1
                  ...
                  <thead>
                    <tr className="text-green-400 bg-gray-800">
                      {[
                        ...
                        { main: "Actions", sub: "Edit / Delete / Notes" },
                      ].map(({ main, sub }) => (
                        <th
                          key={main}
