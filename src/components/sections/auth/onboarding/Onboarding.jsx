...
const Onboarding = () => {
  ...
  const { subscriptionDetails, setSubscriptionDetails } = useUser();
          ...
          <div className="flex flex-col items-center justify-center pt-4 space-y-6">
            ...
            <div className="flex items-center space-x-2 text-4xl font-extrabold">
              ...
              <input
                ...
                className="p-2 text-green-400 bg-gray-700 border-b-2 border-green-400 rounded-lg rounded-br-lg hover:bg-gray-800 focus:bg-gray-950 focus:outline-none"
              />
            </div>
            ...
            <div className="grid w-full grid-cols-2 text-xl bg-gray-900 rounded-lg shadow-lg">
      ...
      case 2:
        return (
          <div className="pb-4 space-y-4 text-center ">
            ...
            <div className="mt-4 border-8 border-gray-700 rounded-lg ">
              <img
                src={backgroundImage}
