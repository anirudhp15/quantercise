...
const Register = () => {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`/api/user/${userCredential.uid}/registration-step`, {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full min-h-screen p-4 bg-gradient-to-br from-gray-800 to-black sm:px-6 lg:px-8">
      ...
      <div className="flex flex-col items-center w-full max-w-screen-xl lg:flex-row">
        ...
        <main
          ref={registerRef}
          className="relative z-10 w-full max-w-md p-8 mx-auto space-y-8 bg-gray-900 border-4 border-gray-800 shadow-2xl opacity-0 lg:w-1/2 rounded-xl"
        >
          <motion.div
