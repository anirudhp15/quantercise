[
  ...
  },
  {
    ...
    solution:
      "Yes, it’s possible - Leave switch 1 off. Then, turn switch 2 on for ten minutes. After the ten minutes, turn it off and quickly turn on switch 3. Now, go into the room. The currently lit up bulb connects to switch 3. The bulb that is off but still warm is from switch 2, and the remaining bulb is from switch 1.",
    hints: [
  ...
  },
  {
    ...
    userDifficultyRatings: [6],
    description:
      "In world series, what are the odds it goes 7 games if each team has an equal chance of winning?",
    solution:
  ...
  },
  {
    ...
    userDifficultyRatings: [8],
    description:
      "Describe how Monte Carlo simulations are used to assess the risk of an investment portfolio.",
    solution:
  ...
  {
    id: 63,
    title: "Credit Default Swap (CDS) Pricing",
    difficultyScore: 8,
    difficulty: "Hard",
    userDifficultyRatings: [8],
    description:
      "Explain the basic mechanics of pricing a Credit Default Swap (CDS).",
    solution:
      "A CDS is priced based on the probability of default, the loss given default, and the risk-free discount rate. The premium leg involves periodic payments, while the protection leg involves a potential payment if default occurs.",
    hints: [
      "Understand the premium and protection legs",
      "Consider the probability of default and discount rates",
    ],
    completed: false,
    correct: null,
    attempts: 0,
    ...
    averageTimeToSolve: null,
    interactiveSteps: [
      "Define the CDS structure",
      "Calculate the periodic payments",
      "Assess the potential default payment",
    ],
    isPro: true,
  },
  {
    ...
    userDifficultyRatings: [7],
    description:
      "Explain the Modigliani-Miller Theorem and its implications for corporate finance.",
    solution:
      "The Modigliani-Miller Theorem states that in a perfect market, the value of a firm is unaffected by its capital structure. This implies that financial leverage does not impact the overall cost of capital or value of the firm.",
    hints: [
      "Understand the assumptions of a perfect market",
      "Consider the irrelevance of capital structure",
    ],
    completed: false,
    correct: null,
    attempts: 0,
  ...
  },
  {
    ...
    userDifficultyRatings: [8],
    description:
      "Optimize a portfolio's expected return with constraints on asset weights.",
    solution:
      "Use quadratic programming to maximize the portfolio's expected return subject to constraints on asset weights (e.g., non-negativity, sum to one). The objective function is to maximize return while the constraints ensure proper allocation.",
    hints: ["Use quadratic programming", "Apply constraints on asset weights"],
    completed: false,
    correct: null,
    attempts: 0,
    timeSpent: 0,
  ...
  },
  {
    ...
    userDifficultyRatings: [7],
    description:
      "Calculate the spread of a corporate bond over a risk-free bond.",
    solution:
      "The spread is the difference between the yield on a corporate bond and a comparable risk-free bond. It reflects the additional risk premium required by investors to hold the corporate bond.",
    hints: ["Identify the yields of both bonds", "Calculate the difference"],
    completed: false,
    correct: null,
    attempts: 0,
    timeSpent: 0,
    ...
    averageTimeToSolve: null,
    interactiveSteps: [
      "Define the corporate bond yield",
      "Identify the risk-free yield",
  ...
  },
  {
    ...
    difficulty: "Hard",
    userDifficultyRatings: [8],
    description: "Construct a yield curve from a set of bond prices.",
    solution:
      "Use bootstrapping to derive zero-coupon yields from the prices of coupon-bearing bonds. This involves iterative solving to strip out the implied zero-coupon rates.",
    hints: [
      "Understand the bootstrapping process",
      "Iteratively solve for zero-coupon yields",
    ],
    completed: false,
    correct: null,
    attempts: 0,
  ...
  },
  {
    ...
    userDifficultyRatings: [7],
    description:
      "Explain the International Fisher Effect and its implications for currency markets.",
    solution:
      "The International Fisher Effect states that the difference in nominal interest rates between two countries is equal to the expected change in exchange rates between their currencies. This implies that currencies with higher interest rates will depreciate relative to those with lower rates.",
    hints: [
      "Understand the relationship between interest rates and exchange rates",
      "Consider the implications for currency markets",
    ],
    completed: false,
    correct: null,
    attempts: 0,
    timeSpent: 0,
    category: "Financial Concepts and Modeling",
    tags: ["Finance", "Currency Markets"],
    userFeedback: [],
    averageTimeToSolve: null,
    interactiveSteps: [
      "Define the International Fisher Effect",
      "Identify the interest rate differences",
      "Discuss the exchange rate implications",
    ],
    isPro: true,
  },
  {
    ...
    userDifficultyRatings: [8],
    description:
      "Explain how to value real options in a capital budgeting context.",
    solution:
      "Real options are valued using techniques similar to financial options, such as the Black-Scholes model or binomial trees. They provide the flexibility to make future investment decisions, adding value to the underlying project.",
    hints: [
      "Understand the concept of real options",
      "Use option valuation techniques",
    ],
    completed: false,
    correct: null,
    attempts: 0,
    timeSpent: 0,
    category: "Financial Concepts and Modeling",
    tags: ["Finance", "Capital Budgeting"],
    userFeedback: [],
    averageTimeToSolve: null,
    interactiveSteps: [
      "Define real options",
      "Apply option valuation models",
      "Assess the value added to the project",
    ],
    isPro: true,
  },
  {
    ...
    userDifficultyRatings: [7],
    description:
      "Explain the concept of equity risk premium and how it is estimated.",
    solution:
      "Equity risk premium is the excess return that investing in the stock market provides over a risk-free rate. It is estimated by historical average returns, forward-looking models, or surveys of investors' expectations.",
    hints: [
      "Understand the concept of excess returns",
      "Use historical or forward-looking methods",
    ],
    completed: false,
    correct: null,
    attempts: 0,
    ...
    interactiveSteps: [
      ...
      "Consider forward-looking models",
    ],
    isPro: true,
  },
  {
    ...
    userDifficultyRatings: [7],
    description:
      "Discuss the factors influencing a company's capital structure decisions.",
    solution:
      "Factors include the trade-off between debt and equity, tax advantages of debt, financial flexibility, control considerations, and the costs of financial distress. Companies balance these to optimize their capital structure.",
    hints: [
      "Consider the trade-off between debt and equity",
      "Understand tax advantages and financial distress costs",
    ],
    completed: false,
    correct: null,
    attempts: 0,
  ...
  },
  {
    ...
    userDifficultyRatings: [8],
    description:
      "Explain the concept of Gamma in options trading and its significance.",
    solution:
      "Gamma measures the rate of change of Delta with respect to changes in the underlying asset's price. It indicates the stability of Delta and helps traders understand how Delta will change as the underlying price changes.",
    hints: [
      "Understand the relationship between Delta and Gamma",
      "Consider the impact of Gamma on trading strategies",
    ],
    completed: false,
    correct: null,
    attempts: 0,
    ...
    interactiveSteps: [
      ...
      "Understand its impact on Delta",
    ],
    isPro: true,
  },
  {
    ...
    userDifficultyRatings: [8],
    description:
      "Explain the concept of Vega in options trading and its significance.",
    solution:
      "Vega measures the sensitivity of an option's price to changes in the volatility of the underlying asset. It indicates how much the option's price will change with a 1% change in volatility, helping traders understand the impact of volatility changes.",
    hints: [
      "Understand the relationship between option price and volatility",
      "Consider the impact of Vega on trading strategies",
    ],
    completed: false,
    correct: null,
    attempts: 0,
    ...
    interactiveSteps: [
      "Define Vega",
      "Analyze its significance",
      "Understand its impact on option pricing",
    ],
    isPro: true,
  },
  {
    ...
    userDifficultyRatings: [8],
    description:
      "Explain the concept of Theta in options trading and its significance.",
    solution:
      "Theta measures the sensitivity of an option's price to the passage of time, also known as time decay. It indicates how much the option's price will decrease as the expiration date approaches, helping traders understand the impact of time on option pricing.",
    hints: [
      "Understand the relationship between option price and time",
      "Consider the impact of Theta on trading strategies",
    ],
    completed: false,
    correct: null,
    attempts: 0,
  ...
  },
  {
    ...
    userDifficultyRatings: [8],
    description:
      "Explain the concept of Rho in options trading and its significance.",
    solution:
      "Rho measures the sensitivity of an option's price to changes in interest rates. It indicates how much the option's price will change with a 1% change in interest rates, helping traders understand the impact of interest rate changes on option pricing.",
    hints: [
      "Understand the relationship between option price and interest rates",
      "Consider the impact of Rho on trading strategies",
    ],
    completed: false,
    correct: null,
    attempts: 0,
