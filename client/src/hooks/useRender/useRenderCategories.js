  ...
  return (
    <div ref={containerRef} className="px-4 mx-auto max-w-screen-2xl">
      ...
      <motion.div
        ...
        className="flex flex-col justify-between items-center pb-4 w-full text-xs sm:flex-row"
      >
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 0.5, delay: 0.5 }}
          className="flex items-center mb-4 text-sm sm:mb-0"
        >
        ...
        <motion.div
          ...
          className="flex gap-3 text-xs lg:text-sm lg:gap-4"
        >
          <button
