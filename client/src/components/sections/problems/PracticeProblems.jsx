      ...
      <div className="flex relative z-10 flex-col justify-start py-24 mx-auto max-w-screen-2xl min-h-screen lg:py-32">
        ...
        {!selectedProblem && (
          <motion.h1
            ...
            className={`flex flex-col items-center px-4 py-2 mx-auto w-full max-w-screen-2xl text-4xl font-bold tracking-tight text-center text-white lg:flex-row lg:justify-between`}
          >
            Practice Problems
            {renderCategories && !selectedCategory && (
              <ReactTyped
                ...
                startDelay={500}
                showCursor={false}
                className="h-8 text-2xl font-semibold tracking-wide text-white lg:ml-8"
              />
            )}
            {selectedCategory && (
              <ReactTyped
