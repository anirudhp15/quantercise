...
const Header = ({ onJoinClick }) => {
  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 left-0 z-20 flex items-center justify-between w-full h-16 px-4 transition-all duration-100 border-b-4 border-gray-700 shadow-2xl group lg:px-32 bg-gradient-to-r from-gray-900 via-black to-gray-900 ${
        isPro && !isLandingPage
              ...
              <div className="flex items-center space-x-4">
                ...
                <button
                  className={`group flex rounded-lg items-center px-4 py-1 text-sm font-bold transform border-2 ${
                    isPro
                      ? "text-black bg-blue-400 border-blue-400 hover:text-blue-400 hover:bg-black"
                      : "text-black bg-green-400 border-green-400 hover:text-green-400 hover:bg-black"
                  } `}
